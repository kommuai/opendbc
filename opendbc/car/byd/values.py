...
class CAR(Platforms):
  BYD_ATTO3 = BYDPlatformConfig(
    [BYDCarDocs("BYD Atto 3 2023-26", "ALL", support_type=SupportType.DASHCAM)],
    CarSpecs(mass=2090.0, wheelbase=2.72, steerRatio=16.0),
  )
  BYD_M6 = BYDPlatformConfig(
    [BYDCarDocs("BYD M6 2024-26", "ALL", support_type=SupportType.DASHCAM)],
    CarSpecs(mass=2374.0, wheelbase=2.80, steerRatio=16.0),
  )
  BYD_SEAL = BYDPlatformConfig(
    [BYDCarDocs("BYD Seal 2024-26", "ALL", support_type=SupportType.DASHCAM)],
    CarSpecs(mass=2180.0, wheelbase=2.92, steerRatio=16.0),
  )
  BYD_SEALION7 = BYDPlatformConfig(
    [BYDCarDocs("BYD Sealion 7 2024-26", "ALL", support_type=SupportType.DASHCAM)],
