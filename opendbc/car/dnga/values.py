...
class CAR(Platforms):
  PERODUA_ALZA = DNGAPlatformConfig(
    [
      DNGACarDocs("Perodua Alza 2022-26", "All", support_type=SupportType.DASHCAM),
      DNGACarDocs("Toyota Veloz 2022-26", "All", support_type=SupportType.DASHCAM),
    ],
  ...
  PERODUA_ATIVA = DNGAPlatformConfig(
    [
      DNGACarDocs("Perodua Ativa 2021-26", "All", support_type=SupportType.DASHCAM),
      DNGACarDocs("Perodua Ativa Hybrid 2022", "All", support_type=SupportType.DASHCAM),
      DNGACarDocs("Toyota Raize 2021-26", "All", support_type=SupportType.DASHCAM),
    ],
    CarSpecs(mass=1035.0, wheelbase=2.525, steerRatio=17.0),
  )
  PERODUA_MYVI = DNGAPlatformConfig(
    [DNGACarDocs("Perodua Myvi 2022-26", "All", support_type=SupportType.DASHCAM)],
    CarSpecs(mass=1025.0, wheelbase=2.500, steerRatio=17.4),
  )
  TOYOTA_VIOS = DNGAPlatformConfig(
    [DNGACarDocs("Toyota Vios 2023-26", "All", support_type=SupportType.DASHCAM)],
    CarSpecs(mass=1035.0, wheelbase=2.620, steerRatio=17.0),
    flags=DNGAFlags.SNG,
  )
  QC = DNGAPlatformConfig(
    [DNGACarDocs("Quality Check 2020-24", "All", support_type=SupportType.DASHCAM)],
    CarSpecs(mass=1025.0, wheelbase=2.500, steerRatio=17.4),
  )
